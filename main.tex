...
\begin{document}
	...
	\begin{frame}{Table of contents}
		...
		\tableofcontents[hideallsubsections]
		 \note[item]{COMPROBAR QUE FUNCIONA BIEN CON UNA SEGUNDA PANTALLA, QUE SE MUESTRAN LAS NOTAS EN UNA Y LA PRESENTACIÓN EN OTRA.}
		 \note[item]{COMPROBARLO CON LAS PANTALLAS DE LA PRESENTACIÓN (MI ORDE NO TIENE VGA)}
	\end{frame}
...
Es una realidad que muchas de las empresas y proveedores de servicios de todo el mundo ya han adoptado.
 ...
 \note[item]{
 	SDN ha crecido más allá de su adolescencia y euforia prematura...}
 \note[item]{No es una próxima novedad en el horizonte de la creación de redes...}
\end{frame}


\begin{frame}{Motivación y objetivos II}
\vspace{-2em}
\themename \textit{Rohit Mehra} y \textit{Brad Casemore} en su previsión sobre SDN publicada en 2016:
\vspace{1.3em}
...
\note[item]{VER SI AÑADO ESTA DIAPO O NO, DECIDIRLO CUANDO TENGA TODAS LAS DIAPOS HECHAS, PARA VER SI SON DEMASIADAS. OCUPARÍA 15 SEGUNDOS EXPLICAR ESTA DIAPO, POR TIEMPO NO HABRÍA PROBLEMA}
\end{frame}


% DIAPOSITIVA DEL HISTOGRAMA SOBRE LA ADOPCIÓN DE SDN
\begin{frame}[fragile]{Adopción de las redes SDN}
\begin{figure}
	\centering
	\pgfplotsset{
		select row/.style={
	...
	\vspace{1.5em}\source{\href{https://www.channelinsider.com/networking/slideshows/enterprise-interest-in-sdn-adoption-picks-up-steam.html}{Channel Insider Networking - Michael Vizard}}
	 ...
	 \note[item]{Debido a la creciente demanda en las redes, en estos años se ha visto una evolución en el mercado de redes definidas por software.}
	 \note[item]{Es por esto y por el TFG DE RUBEN que surge el proyecto.}
\end{figure}
\end{frame}
