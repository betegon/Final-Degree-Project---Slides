...
\setbeamertemplate{note page}{\pagecolor{yellow!5}\insertnote}\usepackage{palatino} % MUY IMPORTANTE, ASÍ MUESTRA TAN SOLO UNA NOTA EN  BLANCO EN VEZ DE MOSTRAR UNA DIAPO DE NOTA ESTRUCTURADA (UNA PARTE ES LA NOTA EN SI, OTRA LA SIGUIENTE DIAPO Y OTRA EL ARBOL (SECCION->SUBSECCION->TITLE _RAME) Y NO QUEREMOS ESO.
...
\note[item]{\textcolor{red}{COMPROBAR QUE LOS TITULOS DE ESTAS DIAPOS ESTÁN BIEN: I, II, III, IV, V, ...}}
\end{frame}
