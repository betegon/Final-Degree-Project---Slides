...
\begin{figure}
	...
	\pgfplotstableread[header=false]{
		74 {Suma de las emplean o emplearán}
		26 {No}
		25 {En un futuro}
		21 {En los prox. 2 años}
		28 {Sí}
	}\datatable
	...
	\end{axis}
	\end{tikzpicture}
	\source{\href{https://www.channelinsider.com/networking/slideshows/enterprise-interest-in-sdn-adoption-picks-up-steam.html}{Channel Insider Networking - Michael Vizard}}
\end{figure}
\end{frame}
